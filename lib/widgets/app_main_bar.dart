...
class _AppMainBarState extends State<AppMainBar> {
  ...
  IconButton buildPreferencesIconButton(BuildContext context) {
    return IconButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const PreferencesScreenConnector()));
            },
            icon: const Icon(
  ...
  IconButton buildOverviewIconButton(BuildContext context) {
    return IconButton(
        onPressed: () {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const OverviewScreenConnector()));
        },
        icon: const Icon(
          Icons.add_chart,
          color: Colors.white,
